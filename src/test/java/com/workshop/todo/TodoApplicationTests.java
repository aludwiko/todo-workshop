...
//    private final JsonPath idJsonPath = JsonPath.compile("$.todoId");
	...
	public void shouldReturnGivenTodos() throws Exception {
		Todo todo = new Todo(UUID.randomUUID(), "todo", Optional.empty());
	...
	@Test
	public void shouldReturnNotFoundnPatchNonExistingTodo() throws Exception {
	...
	@Test
	public void shouldReturnNotFoundnWhenTodoNotExist() throws Exception {
